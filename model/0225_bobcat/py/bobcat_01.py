...
3d --watch --background-color 1,1,1 --grid-absolute  <your file-name>.step
'''
...
# bocne ucho + kopia
x2 = BU_Cube([1/4, 1, 1/2], center=True).BU_Tz(1/2/2).BU_Tx((3+1/4)/2)
x3 = BU_Cylinder(1,1/4, hole=False).Ry().BU_Tz(1/2).BU_Tx((3+1/4)/2)
xd = Hole(1).Ry().BU_Tz(1/2).BU_Tx((3)/2)
x2.U([x3])
x2.D(xd)
x2.MKy()
