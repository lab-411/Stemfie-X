...
class Ring_Gear(Stemfie_X):
    def __init__(self, teeth_number=32, width=1/2, rim=1/4):
        Stemfie_X.__init__(self)  
        module=1.0
        straight_ring = RingGear(module=1, teeth_number = teeth_number, width=self.BU*width, rim_width=self.BU*rim)
        self.obj = (self.obj).gear(straight_ring)
