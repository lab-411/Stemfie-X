...
BU  = 10          # zakladna jednotka [mm]
HR  = 3.75/2      # polomer montaznej diery [mm]
HRX = 4.1/2       # polomer diery pre osi [mm]
...
class Stemfie_X(Stemfie_X_Base):
    '''
    Spolocne vlastnosti vsetkych zdedenych tried
    '''
    ...
    def convert_param(self, val):
        '''
        Konverzia rozmerov pre generovanie mien komponentov
        '''
